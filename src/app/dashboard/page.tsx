    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      >
        ...
        <div className="relative z-10 h-full flex flex-col justify-between">
           ...
           <Link href="/dashboard/booking" className="mt-12 inline-flex items-center gap-3 px-8 py-4 bg-[#8E3E96] text-white rounded-2xl font-black text-[10px] uppercase tracking-widest hover:bg-[#6B2D73] transition-all w-fit shadow-lg shadow-[#8E3E96]/20">
