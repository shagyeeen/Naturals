...
function CompanyLoginForm() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#F9F1FF] via-[#FDF9FF] to-[#FFFFFF] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute top-[-100px] left-[-100px] w-[600px] h-[600px] bg-naturals-purple/10 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-10">
          ...
          <p className="text-[10px] font-black text-naturals-purple uppercase tracking-[0.4em] opacity-40">Company Access Portal</p>
        </div>

        <motion.div 
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          className="glass-card p-12 bg-white/90 rounded-[3rem] shadow-[0_30px_100px_-20px_rgba(142,62,150,0.1)] border border-naturals-purple/5"
        >
          <div className="flex items-center justify-between mb-12">
            <div>
              <h2 className="text-2xl font-black text-deep-grape mb-1 italic tracking-tight">Staff Login</h2>
              <p className="text-deep-grape/40 text-[10px] uppercase font-black tracking-[0.2em]">Authorized Management Only</p>
            </div>
            <div className="w-14 h-14 rounded-[1.5rem] bg-deep-grape text-white flex items-center justify-center shadow-lg shadow-deep-grape/20">
          ...
          <div className="space-y-6">
            <button
              ...
              className="w-full py-5 bg-white border border-black/5 text-deep-grape font-black text-xs uppercase tracking-[0.2em] rounded-2xl hover:bg-naturals-purple hover:text-white hover:border-naturals-purple transition-all flex items-center justify-center gap-4 disabled:opacity-50 shadow-sm"
            >
              ...
              {isSubmitting ? "Authenticating..." : "Auth with Google"}
            </button>
            
            <div className="flex items-center justify-center gap-3 opacity-20 group">
               <Lock className="w-3 h-3" />
               <span className="text-[8px] font-black uppercase tracking-[0.4em]">Secure Handshake</span>
            </div>
          </div>
        </motion.div>
