    ...
    <div className={clsx("relative inline-block", className)} id={id}>
      <button
        ...
        className={clsx(
          ...
          "transition-[box-shadow,border,background-color] duration-400 font-black uppercase tracking-widest text-[16px]"
        )}
        style={
          {
      ...
      >
        <svg
          className={clsx(
            "ui-anim-btn-svg mr-3 h-6 w-6 flex-grow-0",
        ...
        <div className="ui-anim-txt-wrapper grid items-center justify-items-center relative">
          <div
            className={clsx(
              "ui-anim-txt-1 col-start-1 row-start-1 flex items-center justify-center whitespace-nowrap",
          ...
          <div
            className={clsx(
              "ui-anim-txt-2 col-start-1 row-start-1 flex items-center justify-center whitespace-nowrap",
